...
public class Main {
    ...
    public static void checkOSVersion(int releaseYear, int clientOS) {                          // Method for Exercise 2
        int oldRelease = 2015;
    ...
    public static void main(String[] args) {
        ...
        результат в консоль.
        *Эту проверку вы уже реализовывали взадании по условным операторам. HomeWork_5 Exercise 3*
        ...
        */
        ...
        System.out.println("\nExercise 2");
        checkOSVersion(releaseYear, clientOS);
